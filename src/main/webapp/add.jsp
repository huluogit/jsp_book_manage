...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<%=request.getContextPath()%>/book.do?type=pageList">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<%=request.getContextPath()%>">图书管理</a><span class="crumb-step">&gt;</span><span>新增书籍</span></div>
        </div>
