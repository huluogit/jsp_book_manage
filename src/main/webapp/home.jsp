    ...
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            ...
            <ul class="navbar-list clearfix">
                <li><a class="on" href="<%=request.getContextPath()%>/book.do?type=pageList">首页</a></li>
                <li><a href="<%=request.getContextPath()%>/book.do?type=pageList" target="_blank">网站首页</a></li>
            </ul>
        </div>
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                <li><a>${username}</a></li>
                <!--<li><a>修改密码</a></li>-->
                <li><a href="<%=request.getContextPath()%>/login.do?type=logout">退出</a></li>
            </ul>
        </div>
    </div>
</div>
<div class="container clearfix">
    <div class="sidebar-wrap">
        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                <li>
                    <ul class="sub-menu">
                        <li><a href="<%=request.getContextPath()%>"><i class="icon-font">&#xe005;</i>图书管理</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<%=request.getContextPath()%>/book.do?type=pageList">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">图书管理</span></div>
        </div>
        <div class="search-wrap">
            <!--用于查询得表单-->
            <div class="search-content">
                <form method="get" action="<%=request.getContextPath()%>/book.do" id="searchForm">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td><img src="<%=request.getContextPath()%>/${i.img}" width="80px" height="85"></td>
                            <td>${i.id}</td>
                            <td>${i.name}</td>
                            <td>${i.author}</td>
                            <td>${i.cate.name}</td>
                            ...
                            <td align="center">
                                <a class="link-update btn btn-success btn2" href="<%=request.getContextPath()%>/book.do?type=detail&id=${i.id}">查看</a>
                                <a class="link-update btn btn-warning btn2" href="<%=request.getContextPath()%>/book.do?type=update&id=${i.id}">修改</a>
                    ...
                    <div class="list-page">
                        ...
                        <ul class="pagination">
                            <li><a href="<%=request.getContextPath()%>/book.do?page=1&type=${type}${params}">首页</a></li>
                            <li><a href="<%=request.getContextPath()%>/book.do?type=${type}&page=${page-1>1?page-1:1}${params}">&laquo;</a></li>

                            <c:forEach begin="1" end="${totalPages}" varStatus="loop">
                                <c:set var="active" value="${loop.index==page?'active':''}"/>
                                <li class="${active}">
                                    <a href="<%=request.getContextPath()%>/book.do?type=${type}&page=${loop.index}${params}">${loop.index}</a>
                                </li>
                            </c:forEach>
                            <li>
                                <a href="<%=request.getContextPath()%>/book.do?type=${type}&page=${page+1<totalPages?page+1:totalPages}${params}">&raquo;</a>
                            </li>
                            <li><a href="<%=request.getContextPath()%>/book.do?type=${type}&page=${totalPages}${params}">尾页</a></li>
                        </ul>
                    </div>
                </div>1
            </form>
...
<script>
    function detete_book(id, obj) {
        layer.confirm('确认要删除吗？', function (index) {
            ...
            $.get("<%=request.getContextPath()%>/book.do", { id: id,type: 'delete'});
    ...
    function many_del() {
        ...
        layer.confirm('确认要删除吗？', function (index) {
            $.get("<%=request.getContextPath()%>/book.do", { idStr: idStr,type: 'batchDel' })
            layer.msg('已删除!', { icon: 1, time: 1000 });
